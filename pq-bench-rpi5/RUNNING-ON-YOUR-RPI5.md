...
This tool lives as the `pq-bench-rpi5/` subfolder of the Logos PoCs mono-repo,
so clone the mono-repo and `cd` into the subfolder:

```sh
git clone https://github.com/logos-blockchain/logos-blockchain-pocs.git
cd logos-blockchain-pocs/pq-bench-rpi5
```
